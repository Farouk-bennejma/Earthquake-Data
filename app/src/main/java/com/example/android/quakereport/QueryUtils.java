...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeItem> fetchEarthquakes() {
        ...
        ArrayList<EarthquakeItem> earthquakes = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<EarthquakeItem> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++){
                ...
                double mag = json_data.getJSONObject("properties").optDouble("mag");
                String place = json_data.getJSONObject("properties").optString("place");
                long time = json_data.getJSONObject("properties").optLong("time");
                String url = json_data.getJSONObject("properties").optString("url");
